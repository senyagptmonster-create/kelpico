...
class AppTheme {
  static const Color cBg = Color(0xFFFAFAF9);
  static const Color cSurface = Color(0xFFFFFFFF);
  static const Color cEdge = Color(0xFFE7E5E4);
  static const Color cAccent = Color(0xFFF97316);
  static const Color cAccent2 = Color(0xFFFDBA74);
  static const Color cInk = Color(0xFF291503);
